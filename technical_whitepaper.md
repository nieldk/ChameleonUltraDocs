...
| --- | --- | --- | --- | --- | --- |
| Sniffing | ISO14443A | Support | Support | Support | `hf 14a sniff` — passive ISO14443-A frame capture via NFCT peripheral; decodes REQA/WUPA, anti-collision, SELECT, AUTH, APDU |
...
| --- | --- | --- | --- | --- | --- |
| Sniffing | 125KHz | Support | Support | Support | `lf sniff` — raw SAADC capture at 125kHz; `data hexsamples`, `data plot`, `data manrawdecode`, `data modulation` for offline analysis |
...
| EM4305 / EM4x69 | ASK (RTF) | Support | Support | Support | `lf em 4x05 read` — gap-encoded READ command, 45-bit Manchester decode, LOGIN support for password-protected tags |
| HID Prox | FSK | Support | Support | Support |  |
| Indala | PSK | Support | Support | Not yet implemented |  |
| FDX-B | ASK | Support | Support | Not yet implemented |  |
| Paradox | FSK | Support | Support | Not yet implemented |  |
...
| --- | --- | --- |
| Standard MIFARE Card | Standard_m1_s50 | ⭐⭐⭐⭐⭐⭐⭐⭐⭐⭐ |
| Chameleon Ultra | Chameleon Ultra | ⭐⭐⭐⭐⭐⭐⭐⭐ |
| Proxmark3 Rdv4.01 | Proxmark3_Rdv4_RRG_(Firmware build at 20201026) | ⭐⭐⭐⭐ |
| RedMi K30 | Xiaomi_k30u_smartkey | ⭐⭐⭐⭐⭐⭐ |
| Chameleon Tiny | Chameleon Tiny | ⭐⭐⭐⭐⭐ |
